...
class CmdbCloudConfig(object):
    ...
    Every hypervisor node in CMDB must have options: role = hypervisor and hypervisor_driver (kvm, openvz, etc).
    """
    TECH_HV_KVM = 'kvm'
    ...
    def get_hypervisors(self, driver=TECH_HV_KVM):
        """
