...
class ResourcesAPITests(APITestCase):
    ...
    def test_resource_retrieve_paged(self):
        ...
        response = self.client.get('/v1/resources/', data={'type': 'assets.serverport'}, format='json')
        ...
        self.assertEqual(200, response.status_code)
        self.assertEqual(24, len(response.data['results']))
    ...
    def test_resource_delete(self):
        ...
        self.assertEqual('assets.server', res2.type)
    ...
    def test_resource_create(self):
        ...
        self.assertEqual('resources.resource', response.data['type'])
    ...
    def test_resource_update_journaling_off(self):
        ...
        response = self.client.put('/v1/resources/%s/' % res2.id,
                                   ...
                                   format='json')
        self.assertEqual(200, response.status_code)
        self.assertEqual(13, len(HistoryEvent.objects.all()))
        ...
        self.client.put('/v1/resources/%s/' % res2.id,
                        ...
                        format='json')
        self.assertEqual(200, response.status_code)
        self.assertEqual(14, len(HistoryEvent.objects.all()))
    ...
    def test_resource_update(self):
        ...
        self.assertEqual('assets.server', response.data['type'])
        self.assertEqual(res2.id, response.data['id'])
        self.assertEqual(res2.parent.id, response.data['parent'])
        self.assertEqual(2, len(response.data['options']))
